...
public var Arudino: ScriptableObject;
...
public var outputBalls1 : GameObject[];
...
{
balls[i].transform.localScale.y = 1 + Mathf.Sqrt(number[i*freq]) * 2;
balls[i].transform.localScale.x = 1 + Mathf.Sqrt(number[i*freq]) * 2;
balls[i].transform.localScale.z = 1 + Mathf.Sqrt(number[i*freq]) * 2;
}
