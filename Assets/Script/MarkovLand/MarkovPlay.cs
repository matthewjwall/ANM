...
public class MarkovPlay : MelodyGenerator {
	...
	public int chainmemory = 9;
	
	public int levelmultiplier = 3;
	
	public bool proceedByDifferences = true;
	...
	public float phraselength = 10.0f;//between 10 - 30 seconds
	...
	public bool bars;
	public float barlength = 1.0f; // length of beat - 1-4 seconds, and no lower than lowest beat
	public float barprob = 1.0f;//prob of forcing a beat - should be quite high 80%->100%
	public float beatcount = 2.0f;//between 2 and6
	public float subbarprob = 1.0f;//prob of forcing a beat - should be quite high 80%->100%
	private float barlocation;
		
	public bool melodic = false;
	public bool diatonic = true;
...
//				maxduration*=2;
		...
		Debug.Log("MELODY: " + melody.volumes + ", " + melody.sounds + ", " + melody.frequencies + ", " + melody.durations + ", " + melody); 
	...
	{		
		...
		while(soundlocation<soundhistory.Count&&frequencylocation<frequencyhistory.Count&&durationlocation<durationhistory.Count)
		{
			...
			Debug.Log("PROCESS: " + sound + ", " + duration + ", " + frequency); 
